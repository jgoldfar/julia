...
.. doctest::
    ...
    julia> spzeros(3,5)
    3×5 sparse matrix with 0 Float64 entries:

    julia> speye(3,5)
    3×5 sparse matrix with 3 Float64 entries:
            [1, 1]  =  1.0
            [2, 2]  =  1.0
            [3, 3]  =  1.0
...
.. doctest::
    ...
    5×18 sparse matrix with 4 Int64 entries:
            [1 ,  4]  =  1
            [4 ,  7]  =  2
            [5 ,  9]  =  3
            [3 , 18]  =  -5
...
.. doctest::
    ...
    julia> sparse(eye(5))
    5×5 sparse matrix with 5 Float64 entries:
            [1, 1]  =  1.0
            [2, 2]  =  1.0
            [3, 3]  =  1.0
            [4, 4]  =  1.0
